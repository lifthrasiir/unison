...
then runs the rebuild the way the editor does, with its stages at once, and reports when the font,
the composites the editor draws and the rest would each reach the editor; and it ends with how long a
