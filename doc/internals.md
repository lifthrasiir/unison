...
| The walk a list popup offers — the selection, the window it is shown through, and the keys that move it — shared by completion and the goto choice | `editor/list_popup.rs` (`ListNav`, `read_move`) |
